...
var AnalysisObj = {
    ...
    setItemNames: lang == 1 ? ["即時指數", "指數比較", "Crow*指數", "積分排名", "數據對比","裁判統計", "陣容情況", "球員評分", "賽前積分", "對賽往績", "近期戰績", "盤路走勢", "相同讓球", "入球分布", "半/全場", "进球数/單雙", "進球時間", "數據比較","賽前簡報", "未來五場"] : ["即时指数", "指数比较", "Crow*指数", "积分排名", "数据对比","裁判统计", "阵容情况", "球员评分", "赛前积分", "对赛往绩", "近期战绩", "盘路走势", "相同让球", "入球分布", "半/全场", "进球数/单双", "进球时间", "数据比较", "赛前简报", "未来五场"],
    //setIteamIndexs: [["0", "1", "2"], ["5,6", "11", "21", "28", "29"], ["8", "10", "13", "14", "24"], ["15", "17", "18", "19", "26"], ["25", "20"]],
    setIteamIndexs: ["0", "1", "2","5,6", "11","22", "21", "28", "29","8", "10", "13", "14","15", "17", "18", "19", "26","25", "20"],
    setItemList: new Array(),
    itemSort: "0^1^2^5,6^11^22^21^28^29^8^10^13^14^15^17^18^19^26^25^20",
    ...
    init: function () {
        ...
        if (this.selectedList == null || this.selectedList == "") {
            this.selectedList = "4#7#5,6#11#30#21#28#29#8#10#13#14#15#17#18#19#26#25#20";//"0#4#1#2#3#7#5,6#11#21#28#8#10#13#14#15#17#18#19#26#22#24#25#20";
            //默认显示的赔率公司
